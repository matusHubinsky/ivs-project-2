...
#
# @file mockup_gui.py
# @brief mockup version for the calculator
#
# @date 12.04.2023
# @author Adam Ďurica
#
...
# Create a Variations menu
variations_menu = Menu(menu_bar, tearoff=0)
variations_menu.add_command(label="Standard")
variations_menu.add_command(label="Scientific")
menu_bar.add_cascade(label="Mode", menu=variations_menu)
...
entry = Entry(window, width=22, font=("Arial", 28), bg='grey90', relief='flat')
entry.grid(row=1, column=0, columnspan=5, padx=5, pady=20, ipady=25)
...
button_dot = Button(window, text=".", width=5, font=("Arial", 19), height=1, fg = 'white', bg='#898C96',
                     relief='flat', bd=3, command=lambda: entry.insert(END, "."))
button_per = Button(window, text="%", width=5, font=("Arial", 19), height=1, fg = 'white', bg='#898C96',
                     relief='flat', bd=3, command=lambda: entry.insert(END, ")"))
button_x = Button(window, text="x", width=5, font=("Arial", 19), height=1, fg = 'white', bg='#898C96',
                     relief='flat', bd=3, command=lambda: entry.insert(END, ")"))
button_y = Button(window, text="y", width=5, font=("Arial", 19), height=1, fg = 'white', bg='#898C96',
                     relief='flat', bd=3, command=lambda: entry.insert(END, ")"))
button_bmi = Button(window, text="BMI", width=5, font=("Arial", 19), height=1, fg = 'white', bg='#898C96',
                     relief='flat', bd=3, command=lambda: entry.insert(END, ")"))
button_pi = Button(window, text="π", width=5, font=("Arial", 19), height=1, fg='white', bg='#898C96',
                   relief='flat', bd=3, command=lambda: entry.insert(END, ")"))
button_e = Button(window, text="e", width=5, font=("Arial", 19), height=1, fg = 'white', bg='#898C96',
                     relief='flat', bd=3, command=lambda: entry.insert(END, ")"))
button_graph = Button(window, text="Graph", width=5, font=("Arial", 19), height=1, fg = 'white', bg='#898C96',
                     relief='flat', bd=3, command=lambda: entry.insert(END, ")"))
button_log = Button(window, text="log", width=5, font=("Arial", 19), height=1, fg = 'white', bg='#898C96',
                     relief='flat', bd=3, command=lambda: entry.insert(END, ")"))
button_ln = Button(window, text="ln", width=5, font=("Arial", 19), height=1, fg = 'white', bg='#898C96',
                     relief='flat', bd=3, command=lambda: entry.insert(END, ")"))
button_absolut = Button(window, text="|x|", width=5, font=("Arial", 19), height=1, fg = 'white', bg='#898C96',
                     relief='flat', bd=3, command=lambda: entry.insert(END, ")"))
button_10x = Button(window, text="10\u02E3", width=5, font=("Arial", 19), height=1, fg = 'white', bg='#898C96',
                     relief='flat', bd=3, command=lambda: entry.insert(END, ")"))


# Add the buttons to the window
# First row of buttons
button_x.grid(row=3,column=1)
button_y.grid(row=2,column=1)
button_pi.grid(row=2,column=2)
button_e.grid(row=2,column=3)
button_per.grid(row=3,column=0)

button_graph.grid(row=2,column=0)
button_bmi.grid(row=4,column=0)
button_absolut.grid(row=5,column=0)
button_10x.grid(row=6,column=0)
button_ln.grid(row=7, column=0)
button_log.grid(row=8,column=0)

button_backspace.grid(row=2, column=4)
button_left_bracket.grid(row=3, column=2)
button_rigth_bracket.grid(row=3, column=3)
button_clear.grid(row=3, column=4)

# Second row of buttons
button_root.grid(row=4, column=1)
button_power.grid(row=4, column=2)
button_faktorial.grid(row=4, column=3)
...
button_8.grid(row=7, column=2)
button_9.grid(row=7, column=3)
button_multiply.grid(row=7, column=4)

# Sixth row of buttons
button_neg.grid(row=8, column=1)
button_0.grid(row=8, column=2)
button_dot.grid(row=8, column=3)
button_equal.grid(row=8, column=4)
