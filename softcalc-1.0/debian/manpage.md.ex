% softcalc(SECTION) | User Commands
%
% "April  8 2023"
...
softcalc - program to do something

# SYNOPSIS

**softcalc** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**softcalc** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **softcalc** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**softcalc** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    softcalc. See **foo.conf**(5) for further details.
...
**softcalc** provides some return codes, that can be used in scripts:
...
Annihilator <xhatal02@fit.vutbr.cz>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Annihilator
