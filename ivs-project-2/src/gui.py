...
bg_image = PhotoImage(file='C:\\Users\\adamd\\OneDrive\\Obrázky\\background2.png')
...
img=PhotoImage(file='C:\\Users\\adamd\\OneDrive\\Obrázky\\test.png')
...
def on_enter_top(button):
    button.config(bg='LightSkyBlue1')

def on_leave_top(button):
    button.config(bg='LightSkyBlue2')
# Create the buttons
button_1 = tk.Button(window, text="1", width=5, font=("Arial", 19), height=1, fg = 'white', bg='grey20',
                     relief='raised', bd=3, command=lambda: entry.insert(tk.END, "1"))
button_2 = tk.Button(window, text="2", width=5, font=("Arial", 19), height=1, fg = 'white', bg='grey20',
                     relief='raised', bd=3, command=lambda: entry.insert(tk.END, "2"))
button_3 = tk.Button(window, text="3", width=5, font=("Arial", 19), height=1, fg = 'white', bg='grey20',
                     relief='raised', bd=3, command=lambda: entry.insert(tk.END, "3"))
button_4 = tk.Button(window, text="4", width=5, font=("Arial", 19), height=1, fg = 'white', bg='grey20',
                     relief='raised', bd=3, command=lambda: entry.insert(tk.END, "4"))
button_5 = tk.Button(window, text="5", width=5, font=("Arial", 19), height=1, fg = 'white', bg='grey20',
                     relief='raised', bd=3, command=lambda: entry.insert(tk.END, "5"))
button_6 = tk.Button(window, text="6", width=5, font=("Arial", 19), height=1, fg = 'white', bg='grey20',
                     relief='raised', bd=3, command=lambda: entry.insert(tk.END, "6"))
button_7 = tk.Button(window, text="7", width=5, font=("Arial", 19), height=1, fg = 'white', bg='grey20',
                     relief='raised', bd=3, command=lambda: entry.insert(tk.END, "7"))
button_8 = tk.Button(window, text="8", width=5, font=("Arial", 19), height=1, fg = 'white', bg='grey20',
                     relief='raised', bd=3, command=lambda: entry.insert(tk.END, "8"))
button_9 = tk.Button(window, text="9", width=5, font=("Arial", 19), height=1, fg = 'white', bg='grey20',
                     relief='raised', bd=3, command=lambda: entry.insert(tk.END, "9"))
button_0 = tk.Button(window, text="0", width=5, font=("Arial", 19), height=1, fg = 'white', bg='grey20',
                     relief='raised', bd=3, command=lambda: entry.insert(tk.END, "0"))
button_plus = tk.Button(window, text="+", width=5, font=("Arial", 19), height=1, relief='raised', fg = 'white',
                        bd=3, bg='red', command=lambda: entry.insert(tk.END, "+"))
button_minus = tk.Button(window, text="-", width=5, height=1, relief='raised', fg = 'white', font=("Arial", 19),
                         bd=3, bg='red', command=lambda: entry.insert(tk.END, "-"))
button_multiply = tk.Button(window, text="*", width=5, font=("Arial", 19), height=1, relief='raised', fg = 'white',
                            bd=3, bg='red', command=lambda: entry.insert(tk.END, "*"))
button_divide = tk.Button(window, text="/", width=5, font=("Arial", 19), height=1, relief='raised', fg = 'white',
                          bd=3, bg='red', command=lambda: entry.insert(tk.END, "/"))
button_root = tk.Button(window, text=chr(0x221A), width=5, font=("Arial", 19), height=1, relief='raised', fg = 'black',
                        bd=3, bg='LightSkyBlue2', command=lambda: entry.insert(tk.END, chr(0x221A)))
button_power = tk.Button(window, text="pow", width=5, font=("Arial", 19), height=1, relief='raised', fg = 'black',
                         bd=3, bg='LightSkyBlue2', command=lambda: entry.insert(tk.END, "**"))
button_faktorial = tk.Button(window, text="!", width=5, height=1, relief='raised', fg = 'black', font=("Arial", 19),
                             bd=3, bg='LightSkyBlue2', command=lambda: entry.insert(tk.END, "!"))
button_neg = tk.Button(window, text="neg", width=5, fg = 'black', font=("Arial", 19),
                       height=1, relief='raised', bd=3, bg='LightSkyBlue2')
button_clear = tk.Button(window, text="C", width=5, font=("Arial", 19), height=1, relief='raised', fg = 'white',
                         bd=3, bg='blue2', command=lambda: entry.delete(0, tk.END))
button_equal = tk.Button(window, text="=", width=5, fg = 'black', font=("Arial", 19),
                         height=1, relief='raised', bd=3, bg='yellow')
